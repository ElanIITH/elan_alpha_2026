...
%c██║ ╚████║ ╚████╔╝ ██║███████║██║╚██████╔╝██║ ╚████║`,
  ...
  return (
    <div className="w-full min-h-screen overflow-y-scroll h-screen">
      ...
      {/* contact us page */}
      <div
        className={`background-layers-3 md:h-[90vh] text-white relative w-full flex flex-col items-center pt-[8vh] md:pt-0 md:justify-center md:items-center transition-all duration-1000 delay-400 ${
          mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
        }`}
      >
        <div className="mt-[27vw] md:mt-[7vh] flex flex-col gap-[2vh] md:gap-[1vh] px-[5vw] md:px-0">
          <div
